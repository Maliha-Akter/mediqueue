                    ...
                    <div className="flex items-center">
                        <div className="relative mr-2 lg:hidden">
                            ...
                            >
                                ...
                                <li className="py-2"><Link href="/my-tutors" className="block text-base font-medium text-gray-700 hover:text-[#aa4465]">My Tutors</Link></li>
                                <li className="py-2"><Link href="/booked-sessions" className="block text-base font-medium text-gray-700 hover:text-[#aa4465]">My Booked Sessions</Link></li>
                            </ul>
                        </div>
                    ...
                    <div className="flex items-center space-x-6">
                        {user ? (
                            <div className="relative border-l border-gray-200 pl-4 flex items-center">
                                ...
                                >
                                    {/* <img
                                        className="h-12 w-12 rounded-full object-cover border-2 border-[#AA4465]"
