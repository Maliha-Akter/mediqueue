...
const AvailableTeacher = () => {
    ...
    return (
        <section className="relative py-24 bg-gradient-to-b from-[#FFF5F8] to-white dark:from-gray-700 dark:to-gray-700 w-full min-h-screen transition-colors duration-500">
                            ...
                            >
                                ...
                                <div className="px-5 pb-5 pt-1">
                                    <button
                                        ...
                                        className="block w-full text-center py-2.5 bg-[#AA4465] text-white font-bold text-xs rounded-lg hover:bg-[#8F3552] transition-all duration-200 cursor-pointer"
                                    >
                                        Book Session
                                    </button>
                                </div>
